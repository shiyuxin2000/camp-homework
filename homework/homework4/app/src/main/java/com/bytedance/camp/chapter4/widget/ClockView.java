...
public class ClockView extends View {
    ...
    private void drawTimeNeedles(Canvas canvas) {
        ...
        float hourUnit=UNIT_DEGREE*5f;
        float hour = (time.getHours()+time.getMinutes()/60f)*hourUnit-90;
        float minute = (time.getMinutes()*UNIT_DEGREE)-90;
        float second = time.getSeconds()*UNIT_DEGREE-90;
        ...
        canvas.drawLine(
                centerX,
                centerY,
                ((float) (centerX + radius * Math.cos(Math.toRadians(hour)) * HOUR_NEEDLE_LENGTH_RATIO)),
                ((float) (centerY + radius * Math.sin(Math.toRadians(hour))* HOUR_NEEDLE_LENGTH_RATIO)),
                needlePaint
                );
        ...
        canvas.drawLine(
                centerX,
                centerY,
                ((float) (centerX + radius * Math.cos(Math.toRadians(minute)) * MINUTE_NEEDLE_LENGTH_RATIO)),
                ((float) (centerY + radius * Math.sin(Math.toRadians(minute))* MINUTE_NEEDLE_LENGTH_RATIO)),
                needlePaint
        );
        ...
        canvas.drawLine(
                centerX,
                centerY,
                ((float) (centerX + radius * Math.cos(Math.toRadians(second)) * SECOND_NEEDLE_LENGTH_RATIO)),
                ((float) (centerY + radius * Math.sin(Math.toRadians(second))* SECOND_NEEDLE_LENGTH_RATIO)),
                needlePaint
        );
    }
